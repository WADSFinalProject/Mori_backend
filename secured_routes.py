...
from middleware import get_current_user, role_required
...
# Batches
@secured_router.post("/batches/", response_model=schemas.ProcessedLeaves,dependencies=[Depends(role_required(["Centra", "Admin"]))])
